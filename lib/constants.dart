...
class ApiConstants {
  static String baseUrl = kProfileMode
      ? 'https://prayojana-api-staging.slashdr.com'
  ...
  static String taskUrl = kProfileMode
        ? 'https://prayojana-api-staging.slashdr.com/rest/tasks_list'
        : 'https://prayojana-api-v1.slashdr.com/rest/tasks_list';

  static String interactionUrl =  kProfileMode
      ? 'https://prayojana-api-staging.slashdr.com/rest/interactions'
  ...
  static String memberNameUrl = kProfileMode
      ? 'https://prayojana-api-staging.slashdr.com/rest/filter/member'
